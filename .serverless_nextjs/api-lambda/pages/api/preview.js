...
/******/ 	return __webpack_require__(__webpack_require__.s = "F8Aw");
/******/ })
/************************************************************************/
/******/ ({
      ...
      /* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
        try {
          ...
          await apiResolver(
            ...
            resolver,
            {previewModeId:"368c02ed2c091301688202f146bb5806",previewModeSigningKey:"d3e02fea02ad23be4e4396be3a93e9e55e9c45bbdf4f85c17a5ca6e8c97cb740",previewModeEncryptionKey:"53c19046ac27989b362178e464eff2c2986c8e8f62e563861cf5358d1448dca1"},
...
var _require$1 = __webpack_require__("KEll");
...
var _require$2 = __webpack_require__("bzos");
...
var _require$3 = __webpack_require__("msIP");

const PassThrough$1 = _require$3.PassThrough;

var _require2 = __webpack_require__("bzos");
...
var fetchNode = __webpack_require__("WtHK")
...
var nodeFetch = __webpack_require__("MK0n")
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return getAllPostsWithSlug; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return getAllPostsForHome; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return getPostAndMore; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getAbout; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return getAllProjects; });
/* harmony import */ var prismic_javascript__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("yXRw");
...
const getAllPostsForHome = async previewData => {
  const data = await fetchAPI(`
    query {
...
const getPostAndMore = async (slug, previewData) => {
  const data = await fetchAPI(`
...
const getAbout = async () => {
  ...
  const data = await fetchAPI(`
    ...
    `);
  return data === null || data === void 0 ? void 0 : (_data$allAbouts = data.allAbouts) === null || _data$allAbouts === void 0 ? void 0 : _data$allAbouts.edges;
};
const getAllProjects = async () => {
  var _projects$allProjects;
  ...
  const projects = await fetchAPI(`
    ...
    `);
  return projects === null || projects === void 0 ? void 0 : (_projects$allProjects = projects.allProjectss) === null || _projects$allProjects === void 0 ? void 0 : _projects$allProjects.edges;
};
